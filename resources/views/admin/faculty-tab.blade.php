...
@section('title') {{'Faculty Tab'}} @endsection
@section('content')
                                            ...
                                            @foreach ($faculty as $key => $faculties)
                                                  <tr>
                                                      ...
                                                      <td>
                                                        <div class="row">
                                                            <div class="col p-0" >
                                                                <button class="btn badge bg-primary" data-toggle="modal" data-target="#ModalView{{$faculties->id}}"><i class="la la-eye"></i></button>
                                                            </div>
                                                            <div class="col p-0">
                                                            ...
                                                            <div class="col p-0">
                                                                <button class="btn badge bg-danger" data-toggle="modal" data-target="#Delete{{$faculties->id}}"><i class="la la-archive"></i></button>
                                                            </div>
                                                        </div>
                                                      </td>
