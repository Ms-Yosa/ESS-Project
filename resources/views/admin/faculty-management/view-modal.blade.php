<div class="modal fade text-left" id="ModalView{{$faculties->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                                   ...
                                   <div class="col-md-9">
                                        <div class="form-group has-icon-left">
                                             <div class="form-control form-control-sm position-relative" >
                                                  ...
                                                  <span style="border-left:1px solid black; padding-left:10px;">{{ $faculties->faculty_name }} {{ $faculties->faculty_middle_name }} {{ $faculties->faculty_surname }} </span>
                                                  </div>
                                             </div>
                                        </div>
                                   </div>
                                   ...
                                   <div class="col-md-9">
                                        <div class="form-group has-icon-left">
                                             <div class="form-control form-control-sm position-relative" >
                                                  ...
                                                  <span style="border-left:1px solid black; padding-left:10px;">{{ $faculties->faculty_email }}</span>
                                                  </div>
                                             </div>
                                        </div>
                                   </div>
                                   ...
                                   <div class="col-md-9">
                                        <div class="form-group has-icon-left">
                                             <div class="form-control form-control-sm position-relative" >
                                                  ...
                                                  <span style="border-left:1px solid black; padding-left:10px;">{{ $faculties->gender }}</span>
                                                  </div>
                                             </div>
                                        </div>
                                   </div>
                                   ...
                                   <div class="col-md-9">
                                        <div class="form-group has-icon-left">
                                             <div class="form-control form-control-sm position-relative" >
                                                  ...
                                                  <span style="border-left:1px solid black; padding-left:10px;">{{ $faculties->birth_month }} {{ $faculties->birth_day }} {{ $faculties->birth_year }}</span>
                                                  </div>
                                             </div>
                                        </div>
                                   </div>
                                   ...
                                   <div class="col-md-9">
                                        <div class="form-group has-icon-left">
                                             <div class="form-control form-control-sm position-relative" >
                                                  ...
                                                  <span style="border-left:1px solid black; padding-left:10px;">{{ $faculties->age}}</span>
                                                  </div>
                                             </div>
                                        </div>
                                   </div>
                                   ...
                                   <div class="col-md-9">
                                        <div class="form-group has-icon-left">
                                             <div class="form-control form-control-sm position-relative" >
                                                  ...
                                                  <span style="border-left:1px solid black; padding-left:10px;">{{ $faculties->bloodtype }}</span>
                                                  </div>
                                             </div>
                                        </div>
                                   </div>
                                   ...
                                   <div class="col-md-9">
                                        <div class="form-group has-icon-left">
                                             <div class="form-control form-control-sm position-relative" >
                                                  ...
                                                  <span style="border-left:1px solid black; padding-left:10px;">{{ $faculties->contact_number }}</span>
                                                  </div>
                                             </div>
                                        </div>
                                   </div>
                                   ...
                                   <div class="col-md-9">
                                        <div class="form-group has-icon-left">
                                             <div class="form-control form-control-sm position-relative" >
                                                  ...
                                                  <span style="border-left:1px solid black; padding-left:10px;">{{ $faculties->address }}</span>
                                                  </div>
                                             </div>
                                        </div>
                                   </div>
