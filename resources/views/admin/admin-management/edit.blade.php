            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('admin.admin-tab') }} ">Admins</a></li>
                        <li class="breadcrumb-item active"><a href="javascript:void(0);"> Admin Update</a></li>
                    </ol>
                </div>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-12">
                                        ...
                                        <h6><label for="name">Name</label></h6>
                                            <input type="text" class="form-control form-control-sm" name="name" placeholder="Enter full name" value="{{ $admin->name}}">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12">
                                        ...
                                        <h6><label for="middle_name">Middle Name</label></h6>
                                            <input type="text" class="form-control form-control-sm" name="middle_name" placeholder="Enter Middle Name" value="{{ $admin->middle_name}}">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12">
                                        ...
                                        <h6><label for="surname">Surname</label></h6>
                                            <input type="text" class="form-control form-control-sm" name="surname" placeholder="Enter Surname" value="{{ $admin->surname}}">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12">
                                        ...
                                        <h6> <p style="font-weight:bold">Gender</p></h6>
                                                ...
                                                <div class="form-check form-check-inline">
                                                <h6><input class="form-check-input" type="radio" name="gender" value="Male" {{ ($admin->gender=="Male")? "checked" : "" }}>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12">
                                        ...
                                        <h6><label for="birth_year">Birth Year</label></h6>
                                            ...
                                            <option value="{{$admin->birth_year}}" {{ ($admin->birth_year ==$admin->birth_year) ? 'selected' : '' }}> 
                                                {{ $admin->birth_year }}
                                                </option>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12">
                                        ...
                                        <h6><label for="birth_day">Day</label></h6>
                                            ...
                                            <option value="{{$admin->birth_day}}" {{ ($admin->birth_day ==$admin->birth_day) ? 'selected' : '' }}> 
                                                {{ $admin->birth_day }}
                                                </option>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control form-control-sm" name="age" min="1" value="{{ $admin->age}}">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12">
                                        ...
                                        <h6><label for="bloodtype">Bloodtype</label></h6>
                                            ...
                                            <option value="{{$admin->bloodtype}}" {{ ($admin->bloodtype ==$admin->bloodtype) ? 'selected' : '' }}> 
                                                {{ $admin->bloodtype }}
                                                </option>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12">
                                        ...
                                        <h6> <label for="contact_number">Contact Number</label></h6>
                                            <input type="tel" class="form-control form-control-sm" name="contact_number" placeholder="09XXXXXXXXX" pattern=[0-9]{11} value="{{ $admin->contact_number}}">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="address" placeholder="Enter your complete current address" value="{{ $admin->address}}">
...
<!--        FACULTY DETAILS                                 -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        ...
                                        <h6><label for="email">Email</label></h6>
                                            <input type="email" class="form-control form-control-sm" name="email" placeholder="Enter email address" value="{{ $admin->email}}">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <button class="btn btn-light"><a href="{{ route('admin.admin-tab') }}" >Cancel</a></button>
                        </div>
                    </form>
                </div>
            </div>
