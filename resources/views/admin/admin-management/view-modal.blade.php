<div class="modal fade text-left" id="ModalView{{$admin->id}}" tabindex="-1" role="dialog" aria-hidden="true">
     <div class="modal-dialog" role="document">
          <div class="modal-content" style=" background-color: #F7F8FA">
               <div class="modal-header" style="background-color:#FBD848;letter-spacing: 3px; color:black">
                    <h4 class="modal-title">{{ __('Admin Information') }}</h4>
                                   ...
                                   <div class="col-md-9">
                                        <div class="form-group has-icon-left">
                                             <div class="form-control form-control-sm position-relative" >
                                                  ...
                                                  <span style="border-left:1px solid black; padding-left:10px;">{{ $admin->name }} {{ $admin->middle_name }} {{ $admin->surname }} </span>
                                                  </div>
                                             </div>
                                        </div>
                                   </div>
                                   ...
                                   <div class="col-md-9">
                                        <div class="form-group has-icon-left">
                                             <div class="form-control form-control-sm position-relative" >
                                                  ...
                                                  <span style="border-left:1px solid black; padding-left:10px;">{{ $admin->email }}</span>
                                                  </div>
                                             </div>
                                        </div>
                                   </div>
                                   ...
                                   <div class="col-md-9">
                                        <div class="form-group has-icon-left">
                                             <div class="form-control form-control-sm position-relative" >
                                                  ...
                                                  <span style="border-left:1px solid black; padding-left:10px;">{{ $admin->gender }}</span>
                                                  </div>
                                             </div>
                                        </div>
                                   </div>
                                   ...
                                   <div class="col-md-9">
                                        <div class="form-group has-icon-left">
                                             <div class="form-control form-control-sm position-relative" >
                                                  ...
                                                  <span style="border-left:1px solid black; padding-left:10px;">{{ $admin->birth_month }} {{ $admin->birth_day }} {{ $admin->birth_year }}</span>
                                                  </div>
                                             </div>
                                        </div>
                                   </div>
                                   ...
                                   <div class="col-md-9">
                                        <div class="form-group has-icon-left">
                                             <div class="form-control form-control-sm position-relative" >
                                                  ...
                                                  <span style="border-left:1px solid black; padding-left:10px;">{{ $admin->age}}</span>
                                                  </div>
                                             </div>
                                        </div>
                                   </div>
                                   ...
                                   <div class="col-md-9">
                                        <div class="form-group has-icon-left">
                                             <div class="form-control form-control-sm position-relative" >
                                                  ...
                                                  <span style="border-left:1px solid black; padding-left:10px;">{{ $admin->bloodtype }}</span>
                                                  </div>
                                             </div>
                                        </div>
                                   </div>
                                   ...
                                   <div class="col-md-9">
                                        <div class="form-group has-icon-left">
                                             <div class="form-control form-control-sm position-relative" >
                                                  ...
                                                  <span style="border-left:1px solid black; padding-left:10px;">{{ $admin->contact_number }}</span>
                                                  </div>
                                             </div>
                                        </div>
                                   </div>
                                   ...
                                   <div class="col-md-9">
                                        <div class="form-group has-icon-left">
                                             <div class="form-control form-control-sm position-relative" >
                                                  ...
                                                  <span style="border-left:1px solid black; padding-left:10px;">{{ $admin->address }}</span>
                                                  </div>
                                             </div>
                                        </div>
                                   </div>
