<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row" >
  <div class="text-center navbar-brand-wrapper d-flex align-items-center pl-2">
    ...
    <a class="navbar-brand brand-logo pl-2"  href="{{ route('faculty.home') }}" style="font-weight:bold"> AMSAI SIS</a>
    </div>
      ...
      <ul class="navbar-nav navbar-nav-right">
        ...
        <li class="nav-item nav-profile dropdown">
          <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
            <span>{{ Auth::guard('faculty')->user()->faculty_name }} {{ Auth::guard('faculty')->user()->faculty_surname }}</span>
          </a>
          <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
            <a class="dropdown-item" href="{{ route('faculty.profile', Auth::guard('faculty')->user()->id) }}">
