...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ URL::to('assets_reference/images/favicon.png') }}">
    <!-- Datatable -->
    ...
    <div id="main-wrapper">
        ...
        <div class="nav-header">
            <a href="#" class="brand-logo">
                <img class="logo-abbr" src="{{ URL::to('assets_reference/images/logo-white-2.png') }}" alt="">
                <img class="logo-compact" src="{{ URL::to('assets_reference/images/logo-text-white.png') }}" alt="">
                <img class="brand-title" src="{{ URL::to('assets_reference/images/logo-text-white.png') }}" alt="">
            </a>
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <img class="img-fluid rounded-circle" width="35" src="{{ URL::to('/assets_reference/images/'. Auth::user()->avatar) }}" alt="{{ Auth::user()->avatar }}">
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
